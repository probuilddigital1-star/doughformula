...
This is a baker's percentage, meaning flour is always 100% and every other ingredient is relative to it. The hydration percentage does not change when you scale the batch up or down. A 75% hydration formula stays 75% hydration whether you are making one loaf or ten. The [Dough Formula calculator](/#calculator) handles the gram weights automatically once you set your hydration target.
