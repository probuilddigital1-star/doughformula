...
The [Dough Formula calculator](/#calculator) includes DDT settings specifically because temperature controls fermentation pace. Enter your target dough temperature, and the calculator tells you what water temperature to use so you hit that target right after mixing. That one number sets the pace for everything that happens in the bowl over the next several hours.

For next steps, read [Desired Dough Temperature And Why It Matters](/fundamentals/desired-dough-temperature/) to see how to calculate and control your dough temperature precisely before fermentation begins.
