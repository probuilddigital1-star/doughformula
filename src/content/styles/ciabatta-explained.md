...
|---|---|---|
| Bread flour (total) | 500g | 100% |
| Water (total) | 410g | 82% |
| Instant yeast (total) | 2g | 0.4% |
| Fine sea salt | 10g | 2% |
...
Cover and rest 30 minutes. Then begin coil folds: every 30 minutes for the first two hours of bulk fermentation. See the [stretch and coil folds guide](/techniques/stretch-folds-vs-coil-folds/) for detailed technique. After each set, the dough will feel stronger and more cohesive even though it is still extremely wet.
...
For more context on how baker's percentages apply to ciabatta formulas, the [baker's percentages guide](/fundamentals/bakers-percentages-explained/) shows how to scale this formula to any batch size.
